...
public class Search {
  ...
  // (same method name, different parameter types/order) except they take an elements of Integers

  // rather than an array of ints; they should all otherwise work the same way (for this, it is

  // OK to either copy/paste code and change it to work with elementss instead, or you can figure

  // out a way to call the 4 methods above; up to you)
  public static int linearSearchFirstelements(ArrayList<Integer> elements, int target) {
